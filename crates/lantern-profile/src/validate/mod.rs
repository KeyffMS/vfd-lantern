...
use lantern_domain::{
    BaudRate, ByteOrder, DataBits, FixedScale, LinkSettings, ModbusFunction, ModbusTable,
    ParameterAccess, ParameterId, Parity, ProfileId, QuantityId, QuantityKind, RawRegisters,
    RegisterAddress, RegisterBlock, RegisterCodec, RegisterCount, RegisterEncoding,
