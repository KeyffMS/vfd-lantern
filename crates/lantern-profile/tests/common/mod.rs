...
backup = true
read_back = { kind = "accepted_raw_set", values = [[100], [101]], documentation_source = "Fictional manual A", hil_report_id = "HIL-DEMO-001" }
  ...
  "parameters": [
    {
      ...
      "required_drive_state": "stopped",
      "write_function": "write_single_register",
      "read_back": {"kind": "accepted_raw_set", "values": [[101], [100]], "documentation_source": "Fictional manual A", "hil_report_id": "HIL-DEMO-001"},
      "backup": true,
      "do_not_bridge": false,
